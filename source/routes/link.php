...
$mukimonoUtilities = [
    ...
    'color' => ['name' => 'Colors', 'icon' => 'palette'],
    ...
    'flex' => ['name' => 'Flex', 'icon' => 'grip-lines-vertical'],
    'font' => ['name' => 'Font', 'icon' => 'font'],
    ...
    'margin' => ['name' => 'Margin', 'icon' => 'ruler-vertical'],
    'menu' => ['name' => 'Menu', 'icon' => 'bars'],
    'notes' => ['name' => 'Notes', 'icon' => 'sticky-note'],
    'overflow' => ['name' => 'Overflow', 'icon' => 'window-maximize'],
    'padding' => ['name' => 'Padding', 'icon' => 'ruler-horizontal'],
    'page' => ['name' => 'Page', 'icon' => 'file-alt'],
    'panel' => ['name' => 'Panels', 'icon' => 'clone'],
    'position' => ['name' => 'Position', 'icon' => 'map-pin'],
    'responsive' => ['name' => 'Responsive', 'icon' => 'mobile-alt'],
    'round' => ['name' => 'Round', 'icon' => 'circle'],
